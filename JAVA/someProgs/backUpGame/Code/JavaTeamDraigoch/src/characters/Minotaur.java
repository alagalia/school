...
public class Minotaur extends Enemy {
    ...
    public Minotaur(String playerName, int health, float moveSpeed, int armor, int lightRadius, float posX, float posY, int meleeAttack){
...
//    public Minotaur(String enemyName, int health, float moveSpeed, int armor, int lightRadius, float posX, float posY) {
//        super(enemyName, health, moveSpeed, armor, lightRadius, posX, posY);
//    }
